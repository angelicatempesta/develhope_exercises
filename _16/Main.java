...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println(conversion());// Put this into a function
    }
    ...
    private static String conversion() {
        ...
        return(conversionDescription);// End
    }
    ...
    private static void exercise2() {
        ...
        for (String name : names) {
            System.out.println(formatting(name));// Call your function
        }
    }
    ...
    private static void print() {
        ...
        System.out.println( "This is a " + lunchType + ", which is a " + description + ". It only costs " + myLunchPrice + " and it weights " + weightInGrams + " grams");
    }
        // Call your function
