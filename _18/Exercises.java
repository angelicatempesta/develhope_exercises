...
public class Exercises {
    ...
    static void printCourse(Course corso) {
        System.out.print("This specific course is an " + corso.courseName);
        System.out.println(" and the class can be of maximum " + corso.maxStudents + " students");
    ...
    private static void exercise2() {
        ...
        for (int i =0; i < studentNames.size(); i++) {
           Student student = createNewStudent(studentNames.get(i), studentAges.get(i));
            System.out.println("This student name is: " + student.name + " and her/his age is: " + student.age);
    ...
    private static void exercise3(Course corso) {
        System.out.println("\nExercise 3:");

        double totalAge = 0;
        for (int age : corso.studentAges) {
            totalAge += age;// Write your code here
        }
        double averageAge = totalAge / corso.studentAges.size();
        System.out.println("L'età media degli studenti del corso è : " + averageAge);
    }
}
