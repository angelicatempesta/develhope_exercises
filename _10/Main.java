...
public class Main {
     ...
     *
     *    If 'isTestRetry' is true we cap the maximum grade at C
     *
     *    Remember was can use ! to invert the value of a boolean, i.e. true -> false
     */
    private static void exercise3() {
        System.out.println("\nExercise 3 - Test Grader:");
        double ourTestScore = 8.8;
        double maxTestScore = 10;
        boolean isTestRetry = false;

        if (ourTestScore >= 90/maxTestScore && isTestRetry != true) {
            System.out.println("A");
        } else if (ourTestScore >= 80/maxTestScore && isTestRetry != true) {
            System.out.println("B");
        } else if (ourTestScore >= 70/maxTestScore && isTestRetry == true){
            System.out.println("C");
        } else if (ourTestScore >= 70/maxTestScore && isTestRetry == false){
            System.out.println("C");
        } else if (ourTestScore >= 60/maxTestScore && isTestRetry == true){
                System.out.println("D");
        } else if (ourTestScore >= 60/maxTestScore && isTestRetry == false){
                System.out.println("D");
    ...
    private static void exercise4Bonus() {
        ...
        if (carIsDrivingFromRightToLeft ^ carIsDrivingFromLeftToRight){
            System.out.println("Safe");//Write your code here
